...
- Deaths or injuries where the article alleges no crime are NOT crime incidents: natural death, suicide (suicidio), drowning (inmersión), a body found with no crime established, or authorities ruling out third-party involvement. The same applies to every kind of accident: workplace or mining (accidente laboral), aviation, sport or recreation, domestic, explosive remnants or landmines, and traffic (rule above). A death is a crime incident only if the article names an aggressor, a suspect, or a criminal investigation into the death; a person reported dead, found dead, who fell, or who died of illness with none of these is NOT a crime incident. An accident stays NOT a crime incident even when police, firefighters, emergency services or a prosecutor respond or investigate its causes, unless a person is accused of causing it.
