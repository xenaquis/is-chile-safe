...
- [ ] 17-01-PLAN.md — DQ-01 offline data-quality verification harness + `17-DATA-QUALITY.md` (wave 1)
- [ ] 17-02-PLAN.md — DQ-04 reproducible SPD/SII/Fiscalía snapshot scripts + `data/snapshots/` (wave 1)
- [ ] 17-03-PLAN.md — DQ-02 canonical `data/SOURCES.md` registry + terms-page host fix (wave 1)
...
| 17. Data Quality, Source Traceability & Methodology | v1.2 | 0/5 | Pending (runs 1st; Wave 0 done) |  |
