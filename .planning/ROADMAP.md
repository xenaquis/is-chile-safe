...
_Re-scoped 2026-06-15 after a live BrowserOS audit + IA spike (spikes 001–003) + a DeepSeek/MiniMax news smoke test. Core finding: the site had rich material but it was "lost" — only 12/346 comunas reachable, rankings didn't link comunas, the news layer built but dark. Audit (tech_debt, 0 blockers): **[milestones/v1.2-MILESTONE-AUDIT.md](milestones/v1.2-MILESTONE-AUDIT.md)**._
...
- [x] 16-01-PLAN.md — Geolocation redesign: resolver.py (name→CUT, accent-insensitive) + classifier emits commune_name (NEWS-01)
...
- [x] 16-03-PLAN.md — Schema slug + orchestrator resolve name→(cut,slug) + live pipeline run → current.json (NEWS-03)

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 16-04-PLAN.md — Surfacing: incident→source + incident→comuna links, bilingual /news/ + /es/noticias/, nav/i18n/sitemap (NEWS-04)
