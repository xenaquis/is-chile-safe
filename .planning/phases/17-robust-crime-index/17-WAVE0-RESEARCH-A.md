...
| S2 SPD homicide | ✅ DONE — see 17-WAVE0-RESEARCH-B.md (comuna-level VHC xlsx) |
| S3 exposure proxy (SII) | ✅ DONE — see 17-WAVE0-RESEARCH-B.md (PUB_COMU.xlsb 2024) |
| **S5 secuestro source (NEW)** | ⚠️ PARTIAL — see 17-WAVE0-RESEARCH-B.md (Fiscalía, regional only) |

**Next:** S2/S3/S5 resolved in `17-WAVE0-RESEARCH-B.md`. Wave 0 complete enough to
