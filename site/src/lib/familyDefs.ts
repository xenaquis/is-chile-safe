...
export const FAMILY_DEFS_ES: Record<string, string> = {
  ...
  vif:             'Incidentes reportados de violencia doméstica e intrafamiliar desagregados por comuna, según estadísticas policiales oficiales del CEAD.',
...
export const RANKING_METHODOLOGY_EN: Record<string, string> = {
  homicidios:      'Reported homicide incidence per 100,000 inhabitants by commune. Includes homicide, femicide, parricide, infanticide, and related offences (CEAD subgroup 101 within the Life Crimes family). Figures represent police-recorded cases (casos policiales — complaints plus arrests in the act), not convictions. Source: CEAD — Ministry of Interior and Public Security, official police statistics.',
  robos_violentos: 'Reported violent robbery incidence per 100,000 inhabitants by commune. Includes robbery with violence and robbery with intimidation. Figures represent police-recorded cases (casos policiales — complaints plus arrests in the act), not convictions. Source: CEAD — Ministry of Interior and Public Security, official police statistics.',
  drogas:          'Reported drug offence incidence per 100,000 inhabitants by commune. Covers the CEAD "Drogas" family — criminal offences under Ley 20.000 (trafficking, micro-trafficking and cultivation). Public drug or alcohol consumption is counted under the Disorder (Incivilidades) family, not here, so this figure understates total drug-related police activity. Figures represent police-recorded cases (casos policiales — complaints plus arrests in the act), not convictions. Source: CEAD — Ministry of Interior and Public Security, official police statistics.',
  ...
  vif:             'Reported domestic and intra-family violence incidence per 100,000 inhabitants by commune. Figures represent police-recorded cases (casos policiales — complaints plus arrests in the act), not convictions. Source: CEAD — Ministry of Interior and Public Security, official police statistics.',
  armas:           'Reported weapons offence incidence per 100,000 inhabitants by commune. Includes illegal possession and trafficking of firearms. Figures represent police-recorded cases (casos policiales — complaints plus arrests in the act), not convictions. Source: CEAD — Ministry of Interior and Public Security, official police statistics.',
  incivilidades:   'Reported public disorder incidence per 100,000 inhabitants by commune. Includes the full CEAD "Incivilidades" family aggregate. Figures represent police-recorded cases (casos policiales — complaints plus arrests in the act), not convictions. Source: CEAD — Ministry of Interior and Public Security, official police statistics.',
...
export const RANKING_METHODOLOGY_ES: Record<string, string> = {
  homicidios:      'Incidencia reportada de homicidios por 100.000 habitantes por comuna. Incluye homicidio, femicidio, parricidio, infanticidio y delitos relacionados (subgrupo CEAD 101 dentro de Delitos contra la Vida). Las cifras corresponden a casos policiales (denuncias más detenciones flagrantes), no a condenas. Fuente: CEAD — Ministerio del Interior y Seguridad Pública, estadísticas policiales oficiales.',
  robos_violentos: 'Incidencia reportada de robos violentos por 100.000 habitantes por comuna. Incluye robo con violencia y robo con intimidación. Las cifras corresponden a casos policiales (denuncias más detenciones flagrantes), no a condenas. Fuente: CEAD — Ministerio del Interior y Seguridad Pública, estadísticas policiales oficiales.',
  drogas:          'Incidencia reportada de delitos de drogas por 100.000 habitantes por comuna. Corresponde a la familia CEAD "Drogas" — delitos de la Ley 20.000 (tráfico, microtráfico y cultivo). El consumo de drogas o alcohol en la vía pública se contabiliza en la familia Incivilidades, no aquí, por lo que esta cifra subrepresenta la actividad policial total asociada a drogas. Las cifras corresponden a casos policiales (denuncias más detenciones flagrantes), no a condenas. Fuente: CEAD — Ministerio del Interior y Seguridad Pública, estadísticas policiales oficiales.',
  propiedad:       'Incidencia reportada de delitos contra la propiedad por 100.000 habitantes por comuna. Incluye robos en lugar habitado, hurtos y fraudes — el total de la familia CEAD "Delitos contra la Propiedad". Las cifras corresponden a casos policiales (denuncias más detenciones flagrantes), no a condenas. Fuente: CEAD — Ministerio del Interior y Seguridad Pública, estadísticas policiales oficiales.',
  vif:             'Incidencia reportada de violencia intrafamiliar por 100.000 habitantes por comuna. Las cifras corresponden a casos policiales (denuncias más detenciones flagrantes), no a condenas. Fuente: CEAD — Ministerio del Interior y Seguridad Pública, estadísticas policiales oficiales.',
  armas:           'Incidencia reportada de delitos de armas por 100.000 habitantes por comuna. Incluye porte ilegal y tráfico de armas de fuego. Las cifras corresponden a casos policiales (denuncias más detenciones flagrantes), no a condenas. Fuente: CEAD — Ministerio del Interior y Seguridad Pública, estadísticas policiales oficiales.',
  incivilidades:   'Incidencia reportada de incivilidades por 100.000 habitantes por comuna. Incluye el total de la familia CEAD "Incivilidades". Las cifras corresponden a casos policiales (denuncias más detenciones flagrantes), no a condenas. Fuente: CEAD — Ministerio del Interior y Seguridad Pública, estadísticas policiales oficiales.',
  vida:            'Incidencia reportada de delitos contra la vida por 100.000 habitantes por comuna. Incluye todos los delitos contra la vida e integridad física de la familia CEAD "Delitos contra la Vida". Las cifras corresponden a casos policiales (denuncias más detenciones flagrantes), no a condenas. Fuente: CEAD — Ministerio del Interior y Seguridad Pública, estadísticas policiales oficiales.',
};

// Shared rate-explainer strings for crime-ranking pages (EN/ES)
export const RANKING_RATE_EXPLAINER_EN: string =
  'Rates are police-recorded cases (casos policiales) per 100,000 residents per year, sourced from CEAD official police statistics. Communes with small or seasonal/touristic resident populations can show very high rates because the figure is divided by a small resident base.';

export const RANKING_RATE_EXPLAINER_ES: string =
  'Las tasas corresponden a casos policiales (denuncias más detenciones flagrantes) por 100.000 residentes al año, según estadísticas policiales oficiales del CEAD. Las comunas con población residente pequeña o estacional/turística pueden presentar tasas muy altas porque la cifra se divide por una base residente reducida.';
